...
import { IDebugAssumptionItem, IDebugAssumptionParams } from './api/debugAssumption';
...
export class DafnyLanguageClient extends LanguageClient {
  ...
  public getDebugAssumptions(param: IDebugAssumptionParams): Promise<IDebugAssumptionItem[]> {
    return this.sendRequest<IDebugAssumptionItem[]>('dafny/counterExample', param);
  }
